...
Main.main = function() {
	try {
		...
		if( js.Boot.__instanceof(err,String) ) {
			haxe.Log.trace("Error setting up - missing one or more JS script dependencies",{ fileName : "Main.hx", lineNumber : 54, className : "Main", methodName : "main", customParams : ["error"]});
			haxe.Log.trace(err,{ fileName : "Main.hx", lineNumber : 55, className : "Main", methodName : "main", customParams : ["error"]});
			return;
		} else throw(err);
	}
